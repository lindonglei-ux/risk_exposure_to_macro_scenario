...
TITLE_LINES = [
    ...
    "",
    "- After a few quarters of expansion above baseline, scenario volatility resurfaces. Real US GDP (\"RGDP\") growth declines quarter-over-quarter (\"QoQ\") by approximately 4.0%. RGDP briefly exceeds the baseline level early in the horizon, but slips below baseline by the end of the scenario. The unemployment rate (\"UR\") begins to weaken after staying below baseline, peaks at 7.8%, then recovers while remaining just below the baseline path.",
    ...
    "- Short-term rates decline from the start of the horizon, with the U.S. 3-month Treasury yield (\"US3\") falling to a 1.0% trough by 3Q 2026.",
    ...
    "- 10-year swap rates dip below baseline. The 10Y swap mirrors the baseline path except for a trough nearly 30 bps lower before converging back with baseline by 3Q 2026.",
    "- Home (\"HP\") and Commercial (\"CREPI\") real estate price indexes fall below baseline by 1.0% and 2.1%, respectively, before recovering and finishing marginally under baseline levels.",
    "- The Corporate Composite Bond Index (\"Corp CI\") troughs at 88 before recovering modestly and ending slightly below baseline.",
    ...
    "A significant turn for Federal Reserve policy, including subdued U.S. Treasury bond operations and regional program sales, sustains rates and enables the scenario's moderate bias to higher rates. Three-month Treasury yields rise toward baseline before falling sharply by mid-horizon, whereas longer-term rates and the federal funds rate fall to a 0.75% to 1% range by the end of 2026. The scenario includes a reduction of the Federal Reserve balance sheet from $9.0 trillion to $6.5 trillion. The Fed reintroduces asset purchases in 2Q 2026 in response to the weakening economy. The asset purchases are matched by allocating 50% to Treasuries, 10% to currency, 0% to repo, and 40% to all other liabilities, including the Treasury General Account.",
    "",
    ...
    "Equity markets face sustained declines, with the S&P 500 settling 18% below baseline in 4Q 2025 before partially recovering by 3Q 2026. Volatility remains elevated as investors reassess corporate earnings and the global growth outlook. Corporate bond spreads widen substantially, pushing the Corporate Composite Index down to 88 at the trough before recovering toward 92 by the end of the horizon. Commodity prices are mixed: West Texas Intermediate (\"WTI\") crude oil drops from $97 per barrel in 2Q 2025 to $67 per barrel by early 2026 before gradually improving to $80 per barrel by 3Q 2026.",
    "Home price and commercial real estate indexes fall below baseline by 1.0% and 2.1%, respectively, before improving marginally. CRE performance remains under pressure as higher vacancies and refinancing challenges persist through 2026.",
    "",
    "International developments",
    "Internationally, economies experience similar slowdowns. Outside of the United States, inflation and currencies remain under pressure with long-run spreads widening. Capital outflows from the U.S. push investors toward emerging market economies seeking higher returns; this produces a synchronized global slowdown as emerging regions absorb those adjustments. Several advanced economies face downgrades of sovereign credit ratings to AA, while others hold stable outlooks on substantial fiscal reforms.",
